...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String SUPERIORSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, SUPERIORSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, SUPERIORSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(SUPERIORSETTINGSNS, "interval");
            if(newInterval != null)
